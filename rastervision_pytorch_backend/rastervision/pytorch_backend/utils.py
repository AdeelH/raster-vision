...
def chip_collate_fn_ss(
    batch: list[tuple[tuple[np.ndarray, np.ndarray], 'Box']],
...
def chip_collate_fn_od(
    batch: list[tuple[tuple['Tensor', 'BoxList'], 'Box']],
