...
class TestObjectDetectionLabels(unittest.TestCase):
    ...
    def test_local_to_global(self):
        local_npboxes = np.array([[0.0, 0.0, 2.0, 2.0], [2.0, 2.0, 4.0, 4.0]])
        ...
        expected_global_npboxes = np.array(
            [[10.0, 10.0, 12.0, 12.0], [12.0, 12.0, 14.0, 14.0]]
        )
    ...
    def test_local_to_normalized(self):
        ...
        expected_norm_npboxes = np.array(
            [[0.0, 0.0, 0.2, 0.02], [0.2, 0.02, 0.4, 0.04]]
        )
    ...
    def test_concatenate(self):
        npboxes = np.array([[4.0, 4.0, 5.0, 5.0]])
        ...
        npboxes = np.array(
            [[0.0, 0.0, 2.0, 2.0], [2.0, 2.0, 4.0, 4.0], [4.0, 4.0, 5.0, 5.0]]
        )
