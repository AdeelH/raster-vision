...
def discover_images(
    dir: PathLike, extensions: Iterable[str] = IMG_EXTENSIONS
) -> list[Path]:
...
def make_image_folder_dataset(
    data_dir: str, classes: Iterable[str] | None = None
) -> DatasetFolder:
    ...
    from rastervision.pipeline.file_system.utils import file_exists, list_paths
